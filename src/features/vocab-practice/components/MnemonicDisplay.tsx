...
export function MnemonicDisplay(props: MnemonicDisplayProps) {
  return (
    <Show when={props.mnemonic}>
      {(text) => (
        <div class="w-full max-w-lg rounded-lg bg-card/60 dark:bg-white/5 p-4">
          <h4 class="mb-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground dark:text-white/40">
            Mnemonic
          </h4>
          <p
