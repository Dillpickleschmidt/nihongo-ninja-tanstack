...
import { CircleQuestionMark, LoaderCircle } from "lucide-solid"
...
export default function AnswerInput(props: AnswerInputProps) {
  ...
  const overlay = new KanaToKanjiOverlay(answerChecker)
      ...
      <div>
        ...
        <div id="sentence-practice-answer-input" class="relative">
          ...
          <Show when={!kagomeReady()}>
            <LoaderCircle class="text-muted-foreground absolute top-1/2 right-4 h-6 w-6 -translate-y-1/2 animate-spin" />
          </Show>
        </div>
