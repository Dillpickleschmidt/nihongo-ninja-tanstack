...
function PracticeContent(props: PracticeContainerProps) {
  ...
  // Set questions when they load from Convex
  createEffect(() => {
...
function HintLegend() {
  ...
  return (
    <div class="bg-card-foreground/10 text-muted-foreground/70 ease-instant-hover-100 fixed right-0 bottom-16 z-10 flex h-46 w-44 flex-col items-start gap-1 rounded-tl-lg border p-4 font-semibold backdrop-blur-md lg:top-[40vh] lg:rounded-l-lg">
      <div>
