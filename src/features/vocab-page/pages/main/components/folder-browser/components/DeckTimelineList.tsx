  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link
          to={props.linkTo}
          class="absolute right-9 rounded-md bg-orange-500/80 px-3 py-1.5 text-xs font-medium font-excalifont text-white transition-colors duration-150 hover:bg-orange-500"
