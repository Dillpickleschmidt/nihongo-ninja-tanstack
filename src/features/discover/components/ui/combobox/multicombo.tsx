// features/explore/components/ui/combobox/multicombo.tsx
...
export function MultiCombobox(props: MultiComboboxProps) {
  return (
    <Combobox.Root<FilterFormat>
      multiple={true}
      options={props.items as FilterFormat[]}
      optionValue="value"
      optionLabel="label"
    ...
    >
      <Combobox.Control
        class={cn(
          "bg-background flex h-10 items-center rounded-md border px-3 shadow-sm",
          props.class,
        )}
      >
        <Combobox.Input
      ...
      <Combobox.Content class="bg-popover text-popover-foreground data-expanded:animate-in data-collapsed:animate-out data-collapsed:fade-out-0 data-expanded:fade-in-0 data-collapsed:zoom-out-95 data-expanded:zoom-in-95 relative z-50 max-h-60 min-w-32 overflow-hidden rounded-md border shadow-md">
