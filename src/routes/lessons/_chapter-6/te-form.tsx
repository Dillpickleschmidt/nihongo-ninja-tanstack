    ...
    <div class="relative pb-32">
      ...
      <div class="space-y-14 px-8">
          ...
          <div class="grid gap-3 sm:grid-cols-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              ...
              <ul class="space-y-1.5 text-sm text-muted-foreground dark:text-white/60">
                <li>
                  <span class="font-japanese text-foreground/80 dark:text-white/80">〜てください</span>{" "}
                  - Making polite requests{" "}
                  <span class="text-muted-foreground/70 dark:text-white/30">("Please do...")</span>
                </li>
                <li>
                  <span class="font-japanese text-foreground/80 dark:text-white/80">Verb て、Verb</span>{" "}
                  - Connecting multiple actions{" "}
                  <span class="text-muted-foreground/70 dark:text-white/30">("do X and then Y")</span>
                </li>
                <li>
                  ...
                  - Asking permission{" "}
                  <span class="text-muted-foreground/70 dark:text-white/30">("May I...?")</span>
                </li>
                <li>
                  <span class="font-japanese text-foreground/80 dark:text-white/80">
                    〜てはいけません
                  ...
                  <span class="text-muted-foreground/70 dark:text-white/30">("Must not...")</span>
                </li>
              </ul>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              ...
              <ul class="space-y-1.5 text-sm text-muted-foreground dark:text-white/60">
                <li>
                  <span class="font-japanese text-foreground/80 dark:text-white/80">〜ている</span> -
                  Ongoing actions/states{" "}
                  <span class="text-muted-foreground/70 dark:text-white/30">(Next Chapter)</span>
                </li>
                <li>
                  <span class="font-japanese text-foreground/80 dark:text-white/80">〜てみる</span> -
                ...
                <li>
                  <span class="italic text-muted-foreground/70 dark:text-white/30">+ many more!</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <RevealBlock closedLabel="Quick review: Japanese verbs">
          <div class="space-y-4">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              <p class="font-semibold text-foreground/80 dark:text-white/80">Identifying Verbs</p>
              <p class="mt-2 text-sm text-muted-foreground dark:text-white/60">
                All Japanese verbs end in a character with an{" "}
                <span class="font-semibold text-foreground/80 dark:text-white/80">u-sound</span>{" "}
                <span class="text-muted-foreground/70 dark:text-white/30">(in dictionary form)</span>:
              </p>
              <div class="mt-3 grid grid-cols-4 gap-2 font-japanese text-lg sm:grid-cols-8">
                {["う", "つ", "む", "ぶ", "く", "ぐ", "す", "る"].map((k) => (
                  <div class="rounded bg-card/60 dark:bg-white/[0.04] p-2 text-center text-foreground/75 dark:text-white/70">
                    {k}
                  </div>
                ))}
              </div>
            ...
            <div class="grid gap-3 sm:grid-cols-2">
              <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
                <p class="font-semibold text-foreground/80 dark:text-white/80">Ichidan Verbs:</p>
                <ul class="mt-2 space-y-1 text-sm text-muted-foreground dark:text-white/60">
                  <li>
              ...
              <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
                <p class="font-semibold text-foreground/80 dark:text-white/80">Godan Verbs:</p>
                <ul class="mt-2 space-y-1 text-sm text-muted-foreground dark:text-white/60">
        ...
        <div class="space-y-4">
          ...
          <div class="overflow-x-auto rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead class="text-sm font-semibold tracking-wider text-muted-foreground/70 dark:text-white/30 w-1/3">
                    Verb Type
                  </TableHead>
                  <TableHead class="text-sm font-semibold tracking-wider text-muted-foreground/70 dark:text-white/30 w-1/3">
                    Rule
              ...
              <TableBody>
                <TableRow>
                  <TableCell class="text-foreground/75 dark:text-white/70">Ichidan verbs</TableCell>
                  <TableCell class="font-japanese text-lg text-foreground/80 dark:text-white/80">
                    る → て
                  </TableCell>
                  <TableCell class="font-japanese text-lg text-foreground/80 dark:text-white/80">
                    食べる → 食べ
                ...
                <TableRow>
                  <TableCell rowSpan={5} class="text-foreground/75 dark:text-white/70">
                    Godan verbs
                  </TableCell>
                  <TableCell class="font-japanese text-lg text-foreground/80 dark:text-white/80">
                    <div class="flex items-center gap-4">
                      ...
                      <div class="text-muted-foreground dark:text-white/40">→</div>
                      <div>って</div>
                    </div>
                  </TableCell>
                  <TableCell class="font-japanese text-lg text-foreground/80 dark:text-white/80">
                ...
                <TableRow>
                  <TableCell class="font-japanese text-lg text-foreground/80 dark:text-white/80">
                    く → いて
                    <div class="mt-2 text-sm italic text-muted-foreground/70 dark:text-white/30">
                      Exception: 行く → 行って
                    </div>
                  </TableCell>
                  <TableCell class="font-japanese text-lg text-foreground/80 dark:text-white/80">
                ...
                <TableRow>
                  <TableCell class="text-foreground/75 dark:text-white/70">Irregular verbs</TableCell>
                  <TableCell class="font-japanese text-lg text-foreground/80 dark:text-white/80" />
                  <TableCell class="font-japanese text-lg text-foreground/80 dark:text-white/80">
                    <div>
                      する →{" "}
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            ...
            <span class="text-sm text-muted-foreground dark:text-white/40">(past, present, etc.)</span>.
            Take the following expression:
          </p>

          <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
            <div class="flex items-baseline justify-between">
              <p class="font-japanese text-lg text-foreground/80 dark:text-white/80">座ってください</p>
              <p class="text-sm text-muted-foreground dark:text-white/40">Please sit.</p>
            </div>
            <p class="mt-2 text-sm text-muted-foreground dark:text-white/60">
          ...
          <p class="text-sm font-semibold text-muted-foreground dark:text-white/60">
            How about connecting sentences?{" "}
            <span class="font-normal text-muted-foreground/70 dark:text-white/30">
        ...
        <AsideBlock>
          <p class="text-sm leading-relaxed text-muted-foreground dark:text-white/60">
            ...
            <span class="text-xs text-muted-foreground/70 dark:text-white/30">
        ...
        <div class="space-y-5">
          ...
          <div class="space-y-6">
            <div class="space-y-3">
              <p class="leading-relaxed text-foreground/75 dark:text-white/70">開ける (to open)</p>
              <SelectText
                answer="開けて"
                a="開けて"
                b="開けって"
            ...
            <div class="space-y-3">
              <p class="leading-relaxed text-foreground/75 dark:text-white/70">急ぐ (to hurry)</p>
              <SelectText
                answer="急いで"
                a="急ぐて"
                b="急いで"
            ...
            <div class="space-y-3">
              <p class="leading-relaxed text-foreground/75 dark:text-white/70">遊ぶ (to play)</p>
              <SelectText
                answer="遊んで"
                a="遊んで"
                b="遊ぶて"
            ...
            <div class="space-y-3">
              <p class="leading-relaxed text-foreground/75 dark:text-white/70">泳ぐ (to swim)</p>
              <SelectText
                answer="泳いで"
                a="泳いで"
                b="泳ぐて"
            ...
            <div class="space-y-3">
              <p class="leading-relaxed text-foreground/75 dark:text-white/70">会う (to meet)</p>
              <SelectText
                answer="会って"
                a="会って"
                b="会うて"
            ...
            <div class="space-y-6 rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              ...
              <div class="space-y-3">
                <p class="leading-relaxed text-foreground/75 dark:text-white/70">買う (to buy)</p>
                <SelectText
                  answer="買って"
                  a="買うて"
                  b="買って"
              ...
              <div class="space-y-3">
                <p class="leading-relaxed text-foreground/75 dark:text-white/70">書く (to write)</p>
                <SelectText
                  answer="書いて"
                  a="書くて"
                  b="書いて"
              ...
              <div class="space-y-3">
                <p class="leading-relaxed text-foreground/75 dark:text-white/70">来る (to come)</p>
                <SelectText
                  answer="来て"
                  a="来きて"
                  b="来いて"
