      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            ...
            <div class="rounded-lg bg-white/[0.04] p-4">
              ...
              <p class="mt-1 text-white/50">I woke up at 6 and studied.</p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="rounded-lg bg-white/[0.04] p-4">
            ...
            <p class="mt-1 text-white/50">I take the bus and go to work.</p>
          </div>
          ...
          <div class="rounded-lg bg-white/[0.04] p-4">
            ...
            <p class="mt-1 text-white/50">I go to work by bus.</p>
          </div>
