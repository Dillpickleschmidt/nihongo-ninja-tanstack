      ...
      <div class="space-y-14 px-8">
        ...
        <div class="leading-relaxed text-foreground/75 dark:text-white/70">
          <p>
            ...
            <span class="font-japanese text-foreground dark:text-white/90">てください</span> is your
        ...
        <div class="space-y-4">
          ...
          <GlowBox>
            <div class="space-y-2 text-center text-lg text-foreground/75 dark:text-white/70">
              <p>1. Take any verb</p>
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-2 gap-2 sm:grid-cols-3">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">見てください</p>
              <p class="text-sm text-muted-foreground dark:text-white/40">Please look</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">聞いてください</p>
              <p class="text-sm text-muted-foreground dark:text-white/40">Please listen</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">読んでください</p>
              <p class="text-sm text-muted-foreground dark:text-white/40">Please read</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">書いてください</p>
              <p class="text-sm text-muted-foreground dark:text-white/40">Please write</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 sm:col-span-2">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">教えてください</p>
              <p class="text-sm text-muted-foreground dark:text-white/40">Please teach me / tell me</p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-6">
          ...
          <AsideBlock label="Casual requests">
            ...
            <div class="mt-3 rounded-lg bg-card/60 dark:bg-white/[0.04] p-3">
              <p class="font-japanese text-base text-foreground/80 dark:text-white/80">
                窓を開けて。
              </p>
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">Open the window.</p>
            ...
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              <div class="space-y-4">
                <div>
                  ...
                  <p class="text-sm italic text-muted-foreground/70 dark:text-white/30">
                    When addressing that one friend who won't stop talking
                    during the movie
                  </p>
                </div>

                <div class="border-t border-border/50 dark:border-white/5 pt-4">
                  <p class="font-japanese text-lg text-foreground/80 dark:text-white/80">
                    黙ってください
                  </p>
                  <p class="text-sm text-muted-foreground dark:text-white/50">
                ...
                <p class="border-t border-border/50 dark:border-white/5 pt-4 text-sm text-muted-foreground dark:text-white/60">
        ...
        <div class="space-y-4">
          ...
          <div class="rounded-lg bg-red-500/5 p-4 ring-1 ring-red-500/20">
            ...
            <p class="mt-2 font-japanese text-base text-muted-foreground dark:text-white/50">
              ❌ ～なくてください
            </p>
          </div>
          ...
          <div class="rounded-lg bg-red-500/5 p-4 ring-1 ring-red-500/20">
            <p class="text-sm font-semibold text-muted-foreground dark:text-white/60">
              You <span class="text-foreground/80 dark:text-white/80">cannot</span> add から after
              てください:
            </p>
            <p class="mt-2 font-japanese text-base text-muted-foreground dark:text-white/50">
              ❌ 食べてくださいから
          ...
          <div>
            <div class="rounded-t-lg border border-b-0 border-red-500/20 bg-red-500/5 p-4">
              <p class="text-sm font-semibold text-muted-foreground dark:text-white/60">
                You <span class="text-foreground/80 dark:text-white/80">cannot</span> add けど after
                てください:
              </p>
              <p class="mt-2 font-japanese text-base text-muted-foreground dark:text-white/50">
                ❌ 座ってくださいけど、静かにしてください。
            ...
            <div class="rounded-b-lg border-t border-border/70 dark:border-white/10 bg-card/60 dark:bg-white/[0.04] p-4">
              <p class="text-sm text-muted-foreground dark:text-white/50">Instead:</p>
              <p class="mt-1 font-japanese text-base text-foreground/75 dark:text-white/70">
                ✅ 座って、静かにしてください。
              </p>
              <p class="mt-2 text-sm text-muted-foreground dark:text-white/50">Or:</p>
              <p class="mt-1 font-japanese text-base text-foreground/75 dark:text-white/70">
                ✅ 静かに座ってください
              </p>
            </div>
