    ...
    <div class="relative pb-32">
      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              <p class="font-japanese text-lg text-foreground/80 dark:text-white/80">安い → 安くて</p>
              <div class="mt-2">
                <p class="text-foreground/75 dark:text-white/70">
                  この店のカレーは
            ...
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              <p class="font-japanese text-lg text-foreground/80 dark:text-white/80">いい → よくて</p>
              <div class="mt-2">
                <p class="text-foreground/75 dark:text-white/70">
                  先生はやさしくて、よくて、
        ...
        <AsideBlock label="Pro tips">
          <div class="mt-2 space-y-4 text-sm leading-relaxed text-muted-foreground dark:text-white/60">
            <div>
              <p>
                The last adjective sets the tense for everything{" "}
                <span class="text-muted-foreground/70 dark:text-white/30">(like verbs)</span>:
              </p>
              <p class="mt-1 font-japanese text-base text-foreground/75 dark:text-white/70">
                テストは難しくて、よくなかったです。
              </p>
              <p class="mt-1 text-muted-foreground dark:text-white/40">
