    ...
    <div class="relative pb-32">
      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <GlowBox>
            <div class="space-y-3 text-center">
              <p class="text-xl">
                <span class="text-base font-light text-muted-foreground dark:text-white/50">X</span> は{" "}
                <span class="text-base font-light text-muted-foreground dark:text-white/50">Y</span> の{" "}
          ...
          <GlowBox>
            <div class="space-y-3 text-center">
              <p class="text-xl">
                <span class="text-base font-light text-muted-foreground dark:text-white/50">X</span> は{" "}
                <span class="text-base font-light text-muted-foreground dark:text-white/50">Y</span>{" "}
                <span class="underline underline-offset-2">と</span>{" "}
                <span class="text-base font-light text-muted-foreground dark:text-white/50">Z</span> の
                あいだ です
              </p>
              <p class="text-muted-foreground dark:text-white/50">
                X is between Y <u>and</u> Z
              </p>
              <p class="text-start text-sm text-muted-foreground dark:text-white/40">
        ...
        <AsideBlock label="Important note">
          <div class="mt-2 space-y-3 text-sm leading-relaxed text-muted-foreground dark:text-white/60">
            <p>
        ...
        <div class="space-y-4">
          ...
          <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
            ...
            <p class="mt-1 text-muted-foreground dark:text-white/50">Who's behind (me)?</p>
            <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">
        ...
        <div class="space-y-4">
          ...
          <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
            ...
            <p class="mt-1 text-muted-foreground dark:text-white/50">The cat is in the box.</p>
            <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">(As cats often are...)</p>
            <div class="mt-3 border-t border-border/50 dark:border-white/5 pt-3">
              <p class="text-sm italic text-muted-foreground dark:text-white/40">
                *You can also drop 中 as に can imply "inside":
              </p>
              <p class="mt-1 font-japanese text-sm text-muted-foreground dark:text-white/50">
                猫は箱にいます
              </p>
              <p class="mt-1 text-sm italic text-muted-foreground dark:text-white/40">
          ...
          <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
            <p class="mb-2 text-sm text-muted-foreground dark:text-white/40">
        ...
        <AsideBlock label="Special case">
          <div class="mt-2">
            ...
            <p class="mt-1 text-sm text-muted-foreground dark:text-white/60">I'm IN the bus</p>
            <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">
...
function LocationCard(props: { jp: string; reading: string; en: string }) {
  return (
    <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
      <span class="font-japanese text-2xl font-medium text-foreground dark:text-white/90">
        {props.jp}
      </span>
