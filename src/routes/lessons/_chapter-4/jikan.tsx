  ...
  return (
    <div class="relative pb-32">
      ...
      >
        <OverviewItem>
          Hours with{" "}
          <span class="font-japanese font-semibold text-muted-foreground dark:text-white/60">時間</span>{" "}
          (no particle needed)
        </OverviewItem>
        <OverviewItem>
      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <GlowBox>
            <p class="text-center text-xl text-foreground dark:text-white/90">
              ...
              <span class="text-sm text-muted-foreground dark:text-white/40">(no particle needed!)</span>
            </p>
          </GlowBox>

          <div class="grid gap-2 sm:grid-cols-3">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <span class="font-japanese text-lg text-foreground dark:text-white/90">一時間</span>
              <span class="ml-2 text-sm text-muted-foreground dark:text-white/40">1 hour</span>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <span class="font-japanese text-lg text-foreground dark:text-white/90">三時間</span>
              <span class="ml-2 text-sm text-muted-foreground dark:text-white/40">3 hours</span>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <span class="font-japanese text-lg text-foreground dark:text-white/90">七時間</span>
              <span class="ml-2 text-sm text-muted-foreground dark:text-white/40">7 hours</span>
            </div>
          </div>
        ...
        <div class="space-y-4">
          ...
          <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
            ...
            <span class="ml-2 text-sm text-muted-foreground dark:text-white/40">about 3 hours</span>
          </div>
        ...
        <div class="space-y-4">
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <span class="font-japanese text-lg text-foreground dark:text-white/90">一時間半</span>
              <span class="ml-2 text-sm text-muted-foreground dark:text-white/40">1.5 hours</span>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <span class="font-japanese text-lg text-foreground dark:text-white/90">七時間半</span>
              <span class="ml-2 text-sm text-muted-foreground dark:text-white/40">7.5 hours</span>
            </div>
          </div>
        ...
        <div class="space-y-4">
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <span class="font-japanese text-lg text-foreground dark:text-white/90">三十分</span>
              <span class="ml-2 text-sm text-muted-foreground dark:text-white/40">30 minutes</span>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <span class="font-japanese text-lg text-foreground dark:text-white/90">四十五分</span>
              <span class="ml-2 text-sm text-muted-foreground dark:text-white/40">45 minutes</span>
            </div>
          </div>
