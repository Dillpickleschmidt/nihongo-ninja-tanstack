      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4 leading-relaxed text-foreground/75 dark:text-white/70">
          <p>
            ...
            saying <span class="font-black text-foreground dark:text-white/90">is not</span> in
            ...
            <div class="relative rounded-xl border-2 border-orange-400 bg-card/60 dark:bg-white/[0.04] p-6 backdrop-blur-sm">
              <div class="space-y-3">
                <div class="flex items-center">
                  ...
                  <p class="mx-3 text-xl text-muted-foreground dark:text-white/50">→</p>
                  <p class="text-xl text-muted-foreground dark:text-white/50">X is Y.</p>
                </div>
                <div class="flex items-center">
                  <p class="w-56 text-2xl md:w-64">
                    X{" "}
                  ...
                  <p class="mx-3 text-xl text-muted-foreground dark:text-white/50">→</p>
                  <p class="text-xl text-muted-foreground dark:text-white/50">
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            ...
            replacing <span class="font-japanese text-xl text-foreground dark:text-white/90">です</span>{" "}
            with{" "}
            <span class="font-japanese text-xl text-foreground dark:text-white/90">じゃないです</span>
            .
          </p>
          ...
          <div class="space-y-3">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">This is a pen.</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              <p class="font-japanese text-xl text-foreground dark:text-white/90">
                これはペン
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed font-semibold text-foreground dark:text-white/90">
              ...
              <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
                <div class="space-y-1 text-sm leading-relaxed text-muted-foreground dark:text-white/60">
                  <p>
                    ...
                    <span class="italic text-muted-foreground dark:text-white/40">Colloquial</span>
                  </p>
                  <p>
                    <span class="font-japanese text-base text-foreground/80 dark:text-white/80">
                      田中さんは 学生 じゃありません。
                    </span>{" "}
                    <span class="italic text-muted-foreground dark:text-white/40">Polite</span>
                  </p>
                  <p>
                    <span class="font-japanese text-base text-foreground/80 dark:text-white/80">
                      田中さんは 学生 ではありません。
                    </span>{" "}
                    <span class="italic text-muted-foreground dark:text-white/40">Formal</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            ...
            <span class="font-semibold text-foreground dark:text-white/90">isn't it?</span> in
            English.
          </p>
          ...
          <div class="space-y-2">
            <p class="text-sm font-medium text-muted-foreground dark:text-white/40">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            ...
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">It's not delicious.</p>
            </div>
          </div>
          ...
          <div class="space-y-3">
            ...
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">It's not expensive.</p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-5">
          ...
          <p class="text-center leading-relaxed text-foreground/75 dark:text-white/70">
