      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <GlowBox>
            <div class="flex w-full justify-evenly font-japanese text-2xl font-semibold">
              <span>
                ア{" "}
                <span class="text-base font-normal text-muted-foreground dark:text-white/50">a</span>
              </span>
              <span>
                イ{" "}
                <span class="text-base font-normal text-muted-foreground dark:text-white/50">i</span>
              </span>
              <span>
                ウ{" "}
                <span class="text-base font-normal text-muted-foreground dark:text-white/50">u</span>
              </span>
              <span>
                エ{" "}
                <span class="text-base font-normal text-muted-foreground dark:text-white/50">e</span>
              </span>
              <span>
                オ{" "}
                <span class="text-base font-normal text-muted-foreground dark:text-white/50">o</span>
              </span>
            </div>
          </GlowBox>
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            ...
            <span class="font-japanese font-semibold text-foreground dark:text-white/90">ー</span> in
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            ...
            <span class="font-semibold text-foreground dark:text-white/90">ya</span>,{" "}
            <span class="font-semibold text-foreground dark:text-white/90">yu</span>, and{" "}
            <span class="font-semibold text-foreground dark:text-white/90">yo</span> sounds, allowing
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">New York</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">
                <Romaji romaji="shyatsu">シャツ</Romaji>
              </p>
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">shirt</p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-3 leading-relaxed text-foreground/75 dark:text-white/70">
            <li>
              In Katakana,{" "}
              <span class="font-japanese text-xl text-foreground dark:text-white/90">シ</span> (shi)
              and <span class="font-japanese text-xl text-foreground dark:text-white/90">ツ</span>{" "}
              (tsu) look very similar but have slightly different stroke
              orientations.{" "}
              <span class="font-japanese text-xl text-foreground dark:text-white/90">シ</span> (shi)
              has flatter strokes, while the strokes in{" "}
              <span class="font-japanese text-xl text-foreground dark:text-white/90">ツ</span> (tsu)
              are more vertical.
            </li>
            ...
            <li class="flex items-center gap-3">
              ...
              <span class="font-japanese text-2xl text-muted-foreground dark:text-white/40">？？</span>
            </li>

            <li>
              You'll notice that the curved lines of{" "}
              <span class="font-japanese text-xl text-foreground dark:text-white/90">シ</span> and{" "}
              <span class="font-japanese text-xl text-foreground dark:text-white/90">ン</span> don't
              go all the way to the top of the character, while the curved lines
              of <span class="font-japanese text-xl text-foreground dark:text-white/90">ツ</span> and{" "}
              <span class="font-japanese text-xl text-foreground dark:text-white/90">ソ</span> do.{" "}
            ...
            <li>
              ...
              <span class="font-japanese text-xl text-foreground dark:text-white/90">シ</span> is
              written from the bottom up, while{" "}
              <span class="font-japanese text-xl text-foreground dark:text-white/90">ツ</span> is
              written from top to bottom.
            </li>
            <li>
              <span class="font-japanese text-xl text-foreground dark:text-white/90">ン</span> (n)
              and <span class="font-japanese text-xl text-foreground dark:text-white/90">ソ</span>{" "}
              (so) are similar.{" "}
              <span class="font-japanese text-xl text-foreground dark:text-white/90">ン</span> (n) is
              also flatter while{" "}
              <span class="font-japanese text-xl text-foreground dark:text-white/90">ソ</span> (so)
              is more vertical.
            </li>
          </ul>
        ...
        <div class="space-y-4">
          <SectionLabel>
            ...
            <span class="font-japanese text-muted-foreground dark:text-white/50">ッ</span>
          </SectionLabel>
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            Just like in Hiragana, Katakana uses the small{" "}
            <span class="font-japanese font-semibold text-foreground dark:text-white/90">ッ</span> to
          ...
          <div class="grid gap-3 sm:grid-cols-3">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4 text-center">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">Luke</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4 text-center">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">
                <Romaji romaji="maaku">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">Mark</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4 text-center">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">Maker</p>
            </div>
          </div>

          <p class="text-center text-xs font-medium text-muted-foreground/70 dark:text-white/30">vs.</p>
          ...
          <div class="grid gap-3 sm:grid-cols-3">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4 text-center">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">Look</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4 text-center">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">
                <Romaji romaji="makku">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">Mac</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4 text-center">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">
                <Romaji romaji="mekka">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">Mecca</p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-5 gap-3">
            {(
              ...
              <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-3 text-center font-japanese text-lg font-medium text-foreground/80 dark:text-white/80">
                {text}
              </div>
            ))}
          </div>
        ...
        <div class="flex justify-center">
          <img
            src="/img/guru.png"
            alt="sensei"
            class="size-14 rounded-full ring-1 ring-border dark:ring-white/10"
          />
        </div>
        ...
        <div class="rounded-lg bg-card/50 dark:bg-white/[0.03] p-6 ring-1 ring-border/60 dark:ring-white/[0.06]">
          ...
          <div class="mt-4 space-y-3 text-sm">
            <div>
              ...
              <p class="mt-0.5 text-muted-foreground dark:text-white/40">
  ...
  return (
    <div class="relative">
      ...
      <div class="relative rounded-xl bg-card/60 dark:bg-white/[0.04] p-4 text-center backdrop-blur-sm">
        <p class="mb-1 font-japanese text-2xl font-semibold text-foreground dark:text-white/90">
          {props.kana}
        </p>
