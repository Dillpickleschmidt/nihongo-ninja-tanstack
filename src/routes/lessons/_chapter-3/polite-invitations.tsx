      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-white/70">
            ...
            <span class="font-japanese text-xl text-white/90">いいです</span>{" "}
            with particles like{" "}
          ...
          <div class="rounded-lg bg-white/[0.04] p-4">
            <div class="space-y-1 font-japanese text-lg text-white/80">
              <p>
          ...
          <p class="leading-relaxed text-white/70">
            ...
            means <span class="font-semibold text-white/90">good</span> or{" "}
            <span class="font-semibold text-white/90">fine</span>. It's an
          ...
          <AsideBlock>
            <p class="text-sm leading-relaxed text-white/60">
              ...
              <span class="font-semibold text-white/80">always</span> uses the{" "}
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-white/70">
            ...
            <span class="font-japanese text-xl text-white/90">ちょっと</span>{" "}
            and{" "}
            <span class="font-japanese text-xl text-white/90"><Furigana furigana={<span class="text-xs">だいじょうぶ</span>}>大丈夫</Furigana></span>.
          </p>
        </div>
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-1.5 text-sm leading-relaxed text-white/60">
            <li>
              <span class="font-semibold text-white/80">Literal meaning:</span>{" "}
              a little / slightly
            </li>
            <li>
              <span class="font-semibold text-white/80">Usage 1:</span>{" "}
              Describing a small amount or short duration
            </li>
            <li>
              <span class="font-semibold text-white/80">Usage 2:</span>{" "}
              Indirect refusal
            </li>
            <li>
              <span class="font-semibold text-white/80">Usage 3:</span>{" "}
              Getting someone's attention politely
            </li>
            <li>
              <span class="font-semibold text-white/80">Usage 4:</span> "Wait a
              minute"
            </li>
          </ul>
          ...
          <div class="space-y-3">
            <div class="rounded-lg bg-white/[0.04] p-4">
              ...
              <p class="text-xs text-white/30">Characters: You, shopkeeper</p>
            ...
            <div class="rounded-lg bg-white/[0.04] p-4">
              ...
              <p class="text-xs text-white/30">Characters: You & Yuki</p>
              <p class="mt-2 text-sm leading-relaxed text-white/60">
            ...
            <div class="rounded-lg bg-white/[0.04] p-4">
              ...
              <p class="text-xs text-white/30">Characters: You & stranger</p>
              <p class="mt-2 text-sm leading-relaxed text-white/60">
            ...
            <div class="rounded-lg bg-white/[0.04] p-4">
              ...
              <p class="text-xs text-white/30">Characters: You & your boss</p>
              <div class="mt-2 space-y-1 text-sm leading-relaxed text-white/60">
                <p>
                  <span class="font-semibold text-white/80">Boss:</span>{" "}
                  <span class="font-japanese text-white/80">
                    仕事、命賭けでやってくれ。
                  </span>{" "}
                ...
                <p>
                  <span class="font-semibold text-white/80">You:</span>{" "}
                  <span class="font-japanese text-white/80">
                    はい、分かりました。
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-1.5 text-sm leading-relaxed text-white/60">
            ...
            <li>
              <span class="font-semibold text-white/80">Usage 1:</span> Asking
              if someone is fine
            </li>
            <li>
              <span class="font-semibold text-white/80">Usage 2:</span>{" "}
            ...
            <li>
              <span class="font-semibold text-white/80">Usage 3:</span> Polite
              refusal
            </li>
          </ul>
          ...
          <div class="space-y-3">
            ...
            <div class="rounded-lg bg-white/[0.04] p-4">
              ...
              <p class="text-xs text-white/30">Characters: You & waiter</p>
              <p class="mt-2 text-sm leading-relaxed text-white/60">
            ...
            <div class="rounded-lg bg-white/[0.04] p-4">
              ...
              <p class="text-xs text-white/30">Characters: You & Hiroshi</p>
              <p class="mt-2 text-sm leading-relaxed text-white/60">
                Hiroshi invites you:{" "}
                <span class="font-japanese text-white/80">
        ...
        <div class="space-y-5">
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-3">
              ...
              <div class="space-y-2">
                <p class="text-sm text-white/50">a) Accepting:</p>
                <WanakanaWrapper enabled={true} watch="">
                  <CustomTextArea
                    spacing={14}
                    class="font-japanese h-28 w-full resize-none text-xl"
