    ...
    <div class="relative pb-32">
      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            <span class="font-semibold italic text-foreground dark:text-white/90">Coffee</span> is
            the topic,{" "}
            <span class="font-semibold italic text-foreground dark:text-white/90">
              it's delicious
            </span>{" "}
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <span class="font-semibold text-foreground dark:text-white/90">1. Topic</span>
              <span class="text-muted-foreground dark:text-white/50">
                {" "}
                (+<span class="font-japanese">は</span>) often comes{" "}
                <span class="font-semibold text-foreground/75 dark:text-white/70">first</span>{" "}
            ...
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              ...
              <span class="text-muted-foreground dark:text-white/50">
                {" "}
                often come{" "}
                <span class="font-semibold text-foreground/75 dark:text-white/70">early</span> in the
                sentence
              </span>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              ...
              <span class="text-muted-foreground dark:text-white/50">
                {" "}
                often{" "}
                <span class="font-semibold text-foreground/75 dark:text-white/70">follow</span> time
                expressions
              </span>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <span class="font-semibold text-foreground dark:text-white/90">4. The object</span>
              <span class="text-muted-foreground dark:text-white/50">
                {" "}
                (+<span class="font-japanese">を</span>) usually comes{" "}
                <span class="font-semibold text-foreground/75 dark:text-white/70">
                  before the verb
                </span>
              </span>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <span class="font-semibold text-foreground dark:text-white/90">5. The verb</span>
              <span class="text-muted-foreground dark:text-white/50">
                {" "}
                almost always comes{" "}
                <span class="font-semibold text-foreground/75 dark:text-white/70">last</span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <p class="text-center text-sm text-muted-foreground dark:text-white/40">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">I like coffee.</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              ...
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">Like coffee.</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
              <p class="text-xs font-semibold uppercase tracking-wider text-muted-foreground/70 dark:text-white/30">
                Or even just
              </p>
              <p class="mt-1 font-japanese text-lg text-foreground/80 dark:text-white/80">好き。</p>
              <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">Like.</p>
            </div>
          </div>
        </div>
