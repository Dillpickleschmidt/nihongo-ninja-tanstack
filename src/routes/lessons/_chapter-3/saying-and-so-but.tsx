      ...
      <div class="space-y-14 px-8">
        ...
        <div class="leading-relaxed text-white/70">
          <p>
            ...
            words that mean{" "}
            <span class="font-semibold text-white/90 underline underline-offset-[3px]">
              and
            </span>
            ,{" "}
            <span class="font-semibold text-white/90 underline underline-offset-[3px]">
        ...
        <div class="space-y-4">
          <div class="flex items-baseline gap-3">
            ...
            <span class="text-lg font-medium text-white/40">Soshite</span>
          </div>
          <p class="leading-relaxed text-white/70">
        ...
        <div class="space-y-4">
          <div class="flex items-baseline gap-3">
            ...
            <span class="text-lg font-medium text-white/40">Sorekara</span>
          </div>
          <p class="leading-relaxed text-white/70">
        ...
        <div class="space-y-4">
          <div class="flex items-baseline gap-3">
            ...
            <span class="text-lg font-medium text-white/40">Demo</span>
          </div>
          <p class="leading-relaxed text-white/70">
          ...
          <AsideBlock>
            <p class="text-sm leading-relaxed text-white/60">
              <span class="font-semibold text-white/80">Important:</span>{" "}
              <span class="font-japanese">でも</span> can{" "}
              <span class="font-semibold text-white/80">only</span> appear at
        ...
        <div class="space-y-4">
          <div class="flex items-baseline gap-3">
            ...
            <span class="text-lg font-medium text-white/40">Kedo</span>
          </div>
          <p class="leading-relaxed text-white/70">
        ...
        <div class="space-y-4">
          ...
          <ol class="space-y-2 leading-relaxed text-white/70">
            <li>
              <span class="font-semibold text-white/90">1.</span> Smooth the
              conversation by providing context before the main point.
            </li>
            <li>
              <span class="font-semibold text-white/90">2.</span> Make requests
        ...
        <div class="space-y-4">
          <div class="flex items-baseline gap-3">
            ...
            <span class="text-lg font-medium text-white/40">Ga</span>
          </div>
          <p class="leading-relaxed text-white/70">
        ...
        <div class="space-y-5">
          ...
          <div class="space-y-6">
            <div class="space-y-2">
              <p class="leading-relaxed text-white/70">
                <span class="font-semibold text-white/90">1.</span> Connect two
            ...
            <div class="space-y-2">
              <p class="leading-relaxed text-white/70">
                <span class="font-semibold text-white/90">2.</span> Express a
            ...
            <div class="space-y-2">
              <p class="leading-relaxed text-white/70">
                <span class="font-semibold text-white/90">3.</span> Try
