      ...
      <div class="space-y-14 px-8">
        ...
        <div class="leading-relaxed text-white/70">
          <p>
            ...
            <span class="font-japanese text-white/90">バスは新しいです</span>{" "}
            (The bus is new), we'll now learn how to modify nouns with
            adjectives to say things like "
            <span class="font-semibold text-white/90">The new bus</span>."
          </p>
        </div>
            ...
            <div class="relative">
              ...
              <div class="mt-4 space-y-3">
                <div class="rounded-lg bg-white/[0.04] p-4">
                  <p class="font-japanese text-lg text-white/60">
                    高い + 建物
                  </p>
                  <div class="mt-2 rounded-lg bg-white/[0.04] px-3 py-2 text-center">
                    <p class="font-japanese text-lg text-white/90">高い建物</p>
                    <p class="text-sm text-white/40">tall building</p>
                  </div>
                </div>
                <div class="rounded-lg bg-white/[0.04] p-4">
                  <p class="font-japanese text-lg text-white/60">
                  ...
                  <div class="mt-2 rounded-lg bg-white/[0.04] px-3 py-2 text-center">
                    ...
                    <p class="text-sm text-white/40">interesting movie</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="rounded-lg bg-white/[0.04] p-4">
                  ...
                  <div class="mt-2 space-y-2">
                    <div class="rounded-lg bg-red-500/5 px-3 py-2 text-center ring-1 ring-red-500/20">
                      <p class="font-japanese text-lg text-white/50 line-through">
                        きれい写真
                      </p>
                    </div>
                    <div class="rounded-lg bg-white/[0.04] px-3 py-2 text-center">
                      <p class="font-japanese text-lg text-white/90">
                        きれい
                      ...
                      <p class="text-sm text-white/40">pretty picture</p>
                    </div>
                  </div>
                </div>
                <div class="rounded-lg bg-white/[0.04] p-4">
                  ...
                  <div class="mt-2 space-y-2">
                    ...
                    <div class="rounded-lg bg-white/[0.04] px-3 py-2 text-center">
                      ...
                      <p class="text-sm text-white/40">quiet room</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <AsideBlock>
          <p class="text-sm leading-relaxed text-white/60">
            ...
            <span class="font-japanese text-white/80">静かじゃない</span>), the
            な is no longer required.
          </p>
          <div class="mt-3 space-y-2">
            <div class="rounded-lg bg-red-500/5 px-3 py-2 text-center ring-1 ring-red-500/20">
              <p class="font-japanese text-sm text-white/50">
                静かじゃない
            ...
            <div class="rounded-lg bg-white/[0.04] px-3 py-2 text-center">
              <p class="font-japanese text-sm text-white/80">
                静かじゃない図書館
              </p>
              <p class="text-xs text-white/40">the not-quiet library</p>
            </div>
          </div>
        </AsideBlock>
        ...
        <div class="space-y-4">
          ...
          <div class="grid gap-3 sm:grid-cols-2">
            <div class="rounded-lg bg-white/[0.04] p-4">
              <p class="font-japanese text-xl font-bold text-white/90">
                とても
              </p>
              <p class="mt-2 font-japanese text-base text-white/70">
                ここはとてもきれいな公園です。
              </p>
