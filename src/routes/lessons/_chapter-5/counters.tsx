      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            ...
            . However, Japanese{" "}
            <span class="font-black text-foreground dark:text-white/90">always</span> uses specific
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-sm text-muted-foreground dark:text-white/60">
...
function GenericCounters() {
  ...
  return (
    <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
      <div class="space-y-0">
        {items.map((item) => (
          <div class="flex items-center justify-between border-b border-border/50 dark:border-white/5 py-2">
            <div class="flex gap-6">
              <span class="font-japanese text-xl font-semibold text-foreground dark:text-white/90 w-12">
                {item.kanji}
              </span>
              <span class="font-japanese text-xl text-muted-foreground dark:text-white/60">
                {item.reading}
              </span>
            </div>
            <span class="text-sm text-muted-foreground dark:text-white/40">{item.en}</span>
          </div>
        ))}
        <div class="flex items-center justify-between pt-2">
          ...
          <span class="text-sm text-muted-foreground dark:text-white/40">How many?</span>
        </div>
      </div>
    </div>
  )
