      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <div class="rounded-lg bg-white/[0.04] p-4">
            ...
            <p class="mt-1 text-white/50">"As for today, you're beautiful"</p>
          </div>

          <p class="leading-relaxed text-white/70">
            "As for today..."{" "}
            <span class="font-black text-white/90">Today?</span> What about{" "}
            <span class="font-black text-white/90">yesterday</span>? Saying "as
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
            <div class="rounded-lg bg-white/[0.04] p-4">
              <p class="font-japanese text-lg text-white/80">今日きれいです</p>
              <p class="mt-1 text-white/50">"You're beautiful today"</p>
              <p class="mt-1 text-sm text-white/30">neutral statement</p>
            </div>
            <div class="rounded-lg bg-white/[0.04] p-4">
            ...
            <div class="rounded-lg bg-white/[0.04] p-4">
              ...
              <p class="mt-1 text-white/50">✗ not grammatical</p>
              <p class="mt-1 text-sm text-white/30">
          ...
          <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
            <div class="rounded-lg bg-white/[0.04] p-4">
              <p class="font-japanese text-lg text-white/80">今日寒いです</p>
              <p class="mt-1 text-white/50">"It's cold today"</p>
              <p class="mt-1 text-sm text-white/30">neutral statement</p>
            </div>
            <div class="rounded-lg bg-white/[0.04] p-4">
              <p class="font-japanese text-lg text-white/80">
              ...
              <p class="mt-1 text-white/50">"As for today, it's cold"</p>
              <p class="mt-1 text-sm text-white/30">
                implying contrast with other days
              </p>
            </div>
            <div class="rounded-lg bg-white/[0.04] p-4">
              ...
              <p class="mt-1 text-white/50">"TODAY is the cold one"</p>
              <p class="mt-1 text-sm text-white/30">
          ...
          <div class="rounded-lg bg-white/[0.04] p-4">
            ...
            <p class="mt-1 text-white/50">"As for me, I like cats"</p>
            <p class="mt-1 text-sm text-white/30">
        ...
        <div class="space-y-4">
          ...
          <div class="rounded-lg bg-white/[0.04] p-4">
            ...
            <p class="mt-1 text-white/50">I don't really like quiet guys.</p>
          </div>
          <div class="space-y-3 leading-relaxed text-white/70">
            ...
            <p class="pl-6 text-white/50">Quiet guys? I don't really like...</p>
            <p>As compared to:</p>
            <p class="pl-6 text-white/50">
              I really don't like{" "}
