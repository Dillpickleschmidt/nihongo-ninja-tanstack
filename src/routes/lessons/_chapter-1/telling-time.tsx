  ...
  return (
    <div class="relative pb-32">
      ...
      >
        <OverviewItem>
          Saying hours with{" "}
          <span class="font-japanese font-semibold text-muted-foreground dark:text-white/60">じ</span>
        </OverviewItem>
      ...
      <div class="grid w-full gap-12 px-8 lg:grid-cols-2 lg:items-start">
        ...
        <div class="space-y-8 leading-relaxed">
          <p class="text-xl font-bold text-foreground dark:text-white/90">
            To say the time in Japanese, simply use the number hour followed by
            じ.
          </p>

          <ul class="space-y-2 text-foreground/75 dark:text-white/70">
            <li>
              4 o'clock is only pronounced{" "}
              <span class="font-japanese font-semibold text-foreground dark:text-white/90 underline underline-offset-2">
                よじ
              </span>
              , not よんじ or しじ.
            </li>
          ...
          <ul class="space-y-2 text-foreground/75 dark:text-white/70">
            ...
            <li class="ml-5 text-muted-foreground dark:text-white/50">
              Ex: 二時 → 2 o'clock
              <br />
              Ex: ２時 → 2 o'clock
            </li>
      ...
      <div class="mx-auto mt-20 max-w-3xl space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            For half hours, use{" "}
            <span class="font-japanese font-semibold text-foreground dark:text-white/90">はん</span>{" "}
            <span class="text-muted-foreground dark:text-white/40">(half)</span>. Usually written with
            kanji{" "}
            <span class="font-japanese font-semibold text-foreground dark:text-white/90">半</span>.
          </p>

          <div class="grid gap-2 sm:grid-cols-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <span class="font-japanese text-lg text-foreground dark:text-white/90">一時半</span>
              <span class="ml-3 text-sm text-muted-foreground dark:text-white/40">1:30</span>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <span class="font-japanese text-lg text-foreground dark:text-white/90">十二時半</span>
              <span class="ml-3 text-sm text-muted-foreground dark:text-white/40">12:30</span>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            ...
            <span class="font-japanese font-semibold text-foreground dark:text-white/90">まえ</span>{" "}
            and{" "}
            <span class="font-japanese font-semibold text-foreground dark:text-white/90">すぎ</span>
            .
          </p>

          <div class="grid gap-2 sm:grid-cols-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="text-sm text-muted-foreground dark:text-white/40">Quarter‑to‑10</p>
              <p class="font-japanese text-lg text-foreground dark:text-white/90">じゅうじまえ</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="text-sm text-muted-foreground dark:text-white/40">Quarter‑past‑10</p>
              <p class="font-japanese text-lg text-foreground dark:text-white/90">じゅうじすぎ</p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="text-sm text-muted-foreground dark:text-white/40">12:30 a.m.</p>
              <p class="font-japanese text-lg text-foreground dark:text-white/90">
                ごぜん じゅうに はん
              </p>
              <p class="font-japanese text-sm text-muted-foreground dark:text-white/50">午前十二半</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="text-sm text-muted-foreground dark:text-white/40">12:30 p.m.</p>
              <p class="font-japanese text-lg text-foreground dark:text-white/90">
                ごご じゅうに はん
              </p>
              <p class="font-japanese text-sm text-muted-foreground dark:text-white/50">午後十二半</p>
            </div>
          </div>
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">あさのくじ</p>
              <p class="text-sm text-muted-foreground dark:text-white/40">9 in the morning</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3">
              <p class="font-japanese text-lg text-foreground dark:text-white/90">よるのくじ</p>
              <p class="text-sm text-muted-foreground dark:text-white/40">9 at night</p>
            </div>
          </div>

          <p class="text-center text-sm font-medium text-muted-foreground dark:text-white/50">
          ...
          <div class="grid grid-cols-2 gap-2 sm:grid-cols-4">
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <p class="text-lg">🌄</p>
              <p class="font-japanese text-lg font-semibold text-foreground dark:text-white/90">
                あさ
              </p>
              <p class="text-xs text-muted-foreground dark:text-white/40">Sunrise – ~10 a.m.</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <p class="text-lg">🌤️</p>
              <p class="font-japanese text-lg font-semibold text-foreground dark:text-white/90">
              ...
              <p class="text-xs text-muted-foreground dark:text-white/40">~10 a.m. – 2/3 p.m.</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <p class="text-lg">🌇</p>
              <p class="font-japanese text-lg font-semibold text-foreground dark:text-white/90">
              ...
              <p class="text-xs text-muted-foreground dark:text-white/40">3/4 p.m. – 7 p.m.</p>
            </div>
            <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] px-4 py-3 text-center">
              <p class="text-lg">🌒</p>
              <p class="font-japanese text-lg font-semibold text-foreground dark:text-white/90">
              ...
              <p class="text-xs text-muted-foreground dark:text-white/40">7 p.m. – Sunrise</p>
            </div>
          </div>
