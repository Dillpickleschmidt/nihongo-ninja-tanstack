  ...
  return (
    <div class="pb-32">
      ...
      >
        ...
        <OverviewItem>
          What the particle{" "}
          <span class="font-japanese font-semibold text-white/60">は</span> does
          (and doesn't do)
        </OverviewItem>
      ...
      <div class="space-y-14 px-8">
        ...
        <GlowBox>
          ...
          <div class="mt-6 space-y-3 font-japanese text-2xl font-bold text-white sm:text-3xl">
            <div class="flex items-baseline justify-between gap-4">
              <span>
                わたし<span class="text-dynamic-accent">は</span> がくせい
                <span class="text-dynamic-accent">です</span>。
              </span>
              <span class="shrink-0 text-sm font-normal text-white/30">
                I am a student.
              </span>
            </div>
            <div class="flex items-baseline justify-between gap-4">
        ...
        <AsideBlock label="The は Particle">
          ...
          <div class="mt-3 font-japanese text-lg text-white/90">
            おとうさん
            <span class="text-dynamic-accent">は</span> せんせいです。
            <span class="ml-3 text-sm text-white/30">
              As for (my) dad, he's a teacher.
            </span>
          </div>
          <p class="mt-3 text-sm leading-relaxed text-white/50">
            It's easy to read{" "}
            <span class="font-japanese text-white/70">は</span> as "is," but
            that's not what it's really doing. You can literally translate it as
            "as for..." or "speaking of..." Everything after{" "}
            <span class="font-japanese text-white/70">は</span> is about the
            topic that precedes{" "}
            <span class="font-japanese text-white/70">は</span>. That's why{" "}
            <span class="font-japanese text-white/70">は</span> is commonly
        ...
        <div class="space-y-4 leading-relaxed text-white/70">
          ...
          <p>
            ...
            <span class="font-japanese text-white/90">がくせい</span> instead of{" "}
            <span class="font-japanese text-white/90">がくせいです</span>) is
            more casual. You'd hear it between close friends or family.
          </p>
          <p>
            It's not always clear-cut though. Two coworkers might use{" "}
            <span class="font-japanese text-white/90">です</span> when they
            first meet and drop it over time. Within a friend group, one person
            might keep using{" "}
            <span class="font-japanese text-white/90">です</span> while nobody
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center gap-3 font-japanese text-lg">
            <span class="text-white/30 line-through decoration-white/20">
              わたしは
            </span>
            <span class="font-semibold text-white">がくせいです。</span>
          </div>
        ...
        <div class="space-y-4">
          ...
          <div>
            <p class="font-japanese text-2xl font-bold text-white/90">
              がくせいです。
            </p>
        ...
        <LessonSummary>
          ...
          <SummaryItem>
            <span class="font-japanese font-semibold text-white/80">は</span> is
            pronounced "wa"
          </SummaryItem>
          <SummaryItem>
            Adding{" "}
            <span class="font-japanese font-semibold text-white/80">です</span>{" "}
