...
function AnouEtto() {
  return (
    <div class="relative pb-32">
      ...
      >
        <OverviewItem>
          <span class="font-japanese font-semibold text-muted-foreground dark:text-white/60">あのう</span>{" "}
          and{" "}
          <span class="font-japanese font-semibold text-muted-foreground dark:text-white/60">えっと</span>{" "}
          for hesitation
        </OverviewItem>
        <OverviewItem>
          <span class="font-japanese font-semibold text-muted-foreground dark:text-white/60">まあ</span>,{" "}
          <span class="font-japanese font-semibold text-muted-foreground dark:text-white/60">
            そうですね
          </span>
          , and{" "}
          <span class="font-japanese font-semibold text-muted-foreground dark:text-white/60">なんか</span>
        </OverviewItem>
      ...
      <div class="space-y-14 px-8">
        ...
        <div class="space-y-4">
          ...
          <p class="leading-relaxed text-foreground/75 dark:text-white/70">
            ...
            <span class="font-japanese font-semibold text-foreground dark:text-white/90">あのう</span>{" "}
            (anou),{" "}
            <span class="font-japanese font-semibold text-foreground dark:text-white/90">えっと</span>{" "}
            (etto),{" "}
            <span class="font-japanese font-semibold text-foreground dark:text-white/90">まあ</span>{" "}
            (maa), and{" "}
        ...
        <FillerSection jp="そうですね" romaji="Sou desu ne">
          ...
          <div class="rounded-lg bg-card/60 dark:bg-white/[0.04] p-4">
            ...
            <p class="mt-1 text-sm text-muted-foreground dark:text-white/40">I see, let's do that.</p>
          </div>
        </FillerSection>
