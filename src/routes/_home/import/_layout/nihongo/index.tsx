// src/routes/_home/import/_layout/nihongo/index.tsx
import { createFileRoute } from "@tanstack/solid-router"
import { queryKeys } from "@/query/utils/query-keys"
import { MethodSelection } from "@/features/import-page/components/MethodSelection"

export const Route = createFileRoute("/_home/import/_layout/nihongo/")({
  staticData: {
    headerConfig: {
      title: "Nihongo Ninja Tools",
  ...
  component: NihongoToolsPage,
})

function NihongoToolsPage() {
  return (
