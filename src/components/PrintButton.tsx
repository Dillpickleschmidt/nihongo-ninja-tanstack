...
function printWithTailwind({
  ...
  const contentWindow = iframe.contentWindow as (Window & { tailwindLoaded?: boolean }) | null
    ...
    try {
      ...
      cw.document.fonts.ready.then(() => {
        ...
        const handleAfterPrint = () => {
          if (!printCompleted) {
            printCompleted = true
            cw.removeEventListener("afterprint", handleAfterPrint)
            cleanup()
          }
        }

        // Listen for print events
        cw.addEventListener("afterprint", handleAfterPrint)
