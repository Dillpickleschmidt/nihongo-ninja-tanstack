...
type KanaCell = [string, string] | [null, string]
type KanaRow = { consonant: string; cells: KanaCell[] }

export default function KanaChart(props: { type: ChartType }) {
  const baseRows: KanaRow[] = [
    {
      consonant: "",
      cells: [
        ["あ", "a"],
