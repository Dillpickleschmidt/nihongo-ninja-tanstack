...
const NumberFieldInput = <T extends ValidComponent = "input">(
  ...
  return (
    <NumberFieldPrimitive.Input
      class={cn(
        "border-input ring-offset-background placeholder:text-muted-foreground data-[invalid]:border-error-foreground data-[invalid]:text-error-foreground flex h-10 w-full rounded-md border bg-transparent px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        local.class,
      )}
      {...others}
    />
