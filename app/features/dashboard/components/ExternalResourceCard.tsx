  ...
  return (
    <ResourceWrapper {...linkProps} class="transition-opacity hover:opacity-80">
      <SmoothCard
        width={190}
        height={160}
        class="relative overflow-hidden p-4 shadow-lg shadow-black"
      >
        ...
        <div class="relative z-10">
          <div class="mb-2 flex items-start justify-between">
            ...
            <div
              class={`h-3.5 w-3.5 rounded-full drop-shadow-sm ${getDifficultyColor(resource.difficulty_rating)}`}
            />
          </div>
          <div class="flex h-24 flex-col justify-end">
            <div class="font-inter text-sm font-semibold text-white drop-shadow-sm drop-shadow-black">
              {truncateText(resource.title, 35)}
            </div>
            <div class="text-muted-foreground text-xs capitalize drop-shadow-sm">
