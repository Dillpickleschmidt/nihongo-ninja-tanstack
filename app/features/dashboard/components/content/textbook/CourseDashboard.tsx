...
function MobileLessonCard(props: { lesson: StaticModule | DynamicModule }) {
  ...
  function getModuleIcon(module: StaticModule | DynamicModule) {
    const moduleType =
    ...
    const iconClasses = {
      ...
      "practice-sentence":
        "text-yellow-600 dark:text-yellow-500 saturate-[75%]",
    ...
    return <SelectedIcon size="22px" class={iconStyle} />
  }
  ...
  function getCardGradient(module: StaticModule | DynamicModule) {
    ...
    const gradientClasses = {
      ...
      "culture-note":
        "bg-gradient-to-br from-pink-400/10 via-card to-pink-500/5",
    ...
    >
      <SmoothCard
        ...
        class={cn(
          ...
          getCardBackground(props.lesson),
        )}
      >
        <div
          class={cn(
            "absolute inset-0 -z-1 hidden rounded-2xl dark:block",
            getCardGradient(props.lesson),
          )}
        />
        <div class="mx-auto flex items-center justify-center">
          {getModuleIcon(props.lesson)}
        </div>
