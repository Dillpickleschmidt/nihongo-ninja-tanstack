-- Fix vocabulary_items insert - remove non-existent base_form column
-- vocabulary_items only has: word, furigana, english (and auto-generated id, created_at, etc)
  ...
  LOOP
    ...
    LOOP
      ...
      VALUES (
        ...
        vocab_item->>'word',
        vocab_item->>'furigana',
        ARRAY[COALESCE(vocab_item->>'english', '')]::TEXT[]
      );
    END LOOP;
