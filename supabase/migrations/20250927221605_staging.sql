...
drop policy "Enable view for users based on user_id" on "public"."profiles";

drop policy "Users can manage their own module completions" on "public"."user_module_completions";

drop policy "Users can update their own profile" on "public"."profiles";

alter table "public"."profiles" drop constraint "profiles_id_fkey";

alter table "public"."user_module_completions" drop constraint "user_module_completions_user_id_fkey";

alter table "public"."user_module_completions" drop constraint "user_module_completions_user_id_module_path_key";

alter table "public"."user_module_completions" drop constraint "user_module_completions_pkey";

alter table "public"."profiles" drop constraint "profiles_pkey";

drop index if exists "public"."idx_user_module_completions_user_id";

drop index if exists "public"."user_module_completions_pkey";

drop index if exists "public"."user_module_completions_user_id_module_path_key";
...
alter table "public"."profiles" drop column "jpdb_api_key";

alter table "public"."profiles" add column "user_id" uuid not null default gen_random_uuid();

alter table "public"."profiles" add column "user_preferences" jsonb not null;

alter table "public"."user_module_completions" alter column "id" drop default;

alter table "public"."user_module_completions" alter column "id" add generated by default as identity;

alter table "public"."user_module_completions" alter column "id" set data type bigint using "id"::bigint;
