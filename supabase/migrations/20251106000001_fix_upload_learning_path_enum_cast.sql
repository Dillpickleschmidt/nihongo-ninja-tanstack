-- Fix type cast in upload_learning_path RPC function
-- Change TEXT[] to practice_mode_enum[] for allowed_practice_modes column
...
BEGIN
  ...
  FOR deck_item IN SELECT * FROM jsonb_array_elements(vocab_decks)
  LOOP
    ...
    -- Insert vocabulary module source for this deck
  ...
  FOR module_item IN SELECT * FROM jsonb_array_elements(module_sources)
  LOOP
    INSERT INTO learning_path_module_sources (
      path_id,
      module_id,
