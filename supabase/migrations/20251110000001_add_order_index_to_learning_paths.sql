-- Add order_index column to learning_path_module_sources for deterministic ordering

ALTER TABLE learning_path_module_sources
ADD COLUMN order_index INTEGER NOT NULL DEFAULT 0;

-- Drop old RPC function
DROP FUNCTION IF EXISTS upload_learning_path(UUID, JSONB, JSONB[], JSONB[]);

-- Recreate RPC function with order_index support
