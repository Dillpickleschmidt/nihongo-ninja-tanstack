-- Update upload_learning_path RPC: use deckPOS field to set is_verb for all words in deck
-- Each deck has a single deckPOS value (動詞 or other POS) that applies to all words
...
BEGIN
  ...
  LOOP
    ...
    -- Use deckPOS to set is_verb for all words in the deck
