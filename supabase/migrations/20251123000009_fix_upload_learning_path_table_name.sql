-- Fix upload_learning_path RPC to use deck_vocabulary_items instead of vocabulary_items
-- The vocabulary_items table was renamed to deck_vocabulary_items in migration 20251123000000
