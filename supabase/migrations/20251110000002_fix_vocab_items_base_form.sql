-- Fix upload_learning_path RPC: remove base_form column reference
-- The vocabulary_items table only has 'word' column, not 'base_form'
-- The 'word' column already contains the base_form from kagome tokenization
