-- Update upload_learning_path RPC to use JSONB for transcript_line_ids
-- Much simpler - just pass through the JSONB directly
...
BEGIN
  ...
  FOR deck_index IN 1..array_length(vocab_decks, 1) LOOP
    ...
    -- Create vocabulary module source - JSONB is passed through directly
