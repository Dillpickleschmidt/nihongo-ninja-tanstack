-- Update upload_learning_path RPC to work with new INTEGER[][] transcript_line_ids schema
-- This migration runs after 20251110000005_change_transcript_line_ids_to_nested_arrays.sql
...
BEGIN
  ...
  FOR deck_index IN 1..array_length(vocab_decks, 1) LOOP
    ...
    VALUES (
      ...
      new_deck_id,
      'vocabulary',
      (deck_item->'transcriptLineIds')::integer[][],
  ...
  FOR module_index IN 1..array_length(module_sources, 1) LOOP
    ...
    VALUES (
      ...
      (module_item->'transcriptLineIds')::integer[][],
