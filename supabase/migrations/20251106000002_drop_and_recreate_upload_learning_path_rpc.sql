-- Drop the old upload_learning_path function overloads and recreate with correct enum cast
-- This replaces both the old JSONB[] signature and the incorrect non-array signature
