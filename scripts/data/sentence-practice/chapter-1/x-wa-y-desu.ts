...
export const questions: Question[] = [
  {
    ...
    answers: [
      {
        segments: [
          { text: "私[わたし]は 学生[がくせい]です", blank: true }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    answers: [
      {
        segments: [
          { text: "林[はやし]先生[せんせい]は 先生[せんせい]です", blank: true }
        ]
      }
    ]
  },
  {
    ...
    answers: [
      ...
      {
        segments: [
          { text: "ユキは 高校生[こうこうせい]です", blank: true }
        ]
      },
      {
        segments: [
          { text: "ゆきは 高校生[こうこうせい]です", blank: true }
        ]
      }
    ]
  },
  {
    ...
    answers: [
      {
        segments: [
          { text: "中村[なかむら]さんは 大学生[だいがくせい]です", blank: true }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    answers: [
      {
        segments: [
          { text: "小林[こばやし]さんは 高校生[こうこうせい]です", blank: true }
        ]
      },
      {
        segments: [
  ...
  },
  {
    ...
    answers: [
      {
        segments: [
          { text: "吉田[よしだ]さんは 留学生[りゅうがくせい]です", blank: true }
        ]
      }
    ]
  },
