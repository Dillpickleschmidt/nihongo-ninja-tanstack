    ...
    answers: [
      {
        segments: [
          { text: "明日[あした]、海[うみ]で" },
          { text: "泳[およ]ごう", blank: true, conjugation: { pos: "Godan verb with 'gu' ending", form: "volitional", polarity: "positive", tense: "non-past" } },
        ],
      },
      {
        segments: [
      ...
      },
      {
        segments: [
          ...
          { text: "行[い]こう", blank: true, conjugation: { pos: "Godan verb - Iku/Yuku special class", form: "volitional", polarity: "positive", tense: "non-past" } },
        ],
