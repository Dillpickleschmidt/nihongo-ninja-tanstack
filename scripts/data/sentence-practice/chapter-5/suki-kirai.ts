  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        notes:
          'Using スポーツの中で to explicitly say "among sports, my favorite is tennis" (advanced).',
      },
      {
        segments: [
        ...
        notes:
          'Rephrased to emphasize "I like tennis the most among sports" (advanced).',
      },
    ],
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        notes:
          'Using 一番 to emphasize "least favorite" with the basic structure.',
      },
      {
        segments: [
      ...
      },
      {
        ...
        notes:
          "Using 食べ物の中で to explicitly say \"among foods, my younger brother dislikes fish the most (advanced).'",
      },
      {
        segments: [
          {
        ...
        notes:
          "Rephrased to emphasize \"My younger brother dislikes fish the most among foods (advanced).'",
      },
      {
        segments: [
          { text: "弟[おとうと]の 一番[いちばん]" },
        ...
        notes:
          '"the thing my younger brother dislikes the most is fish, with の in place of 食べ物 to mean "thing" (advanced).\'',
      },
    ],
  },
  {
    ...
    answers: [
      {
        ...
        notes:
          "Using は before 嫌い to emphasize the contrast between fruit and vegetables.",
      },
      {
        segments: [
          {
  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        notes:
          "Using 本の中で to explicitly say 'among books, my favorite is manga' with の in place of 本 (advanced).",
      },
      {
        segments: [
          {
        ...
        notes:
          "Rephrased to emphasize 'I like manga the most among books' (advanced).",
      },
    ],
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        notes:
          "Adding 絶対 to emphasize 'absolutely hates' tea with 父 and は.",
      },
      {
        segments: [
          {
      ...
      },
      {
        ...
        notes:
          "Adding 絶対 to emphasize 'absolutely hates' tea with お父さん and は.",
      },
      {
        segments: [
          {
        ...
        notes:
          "Using 絶対 and 大嫌い for stronger emphasis with お父さん and は.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        notes:
          "Omitting 私 and using けど for a polite and conversational contrast.",
      },
    ],
  },
]
